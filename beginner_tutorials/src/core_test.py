...
def fnPublish(key):
    global pub_avoidance,pub_stop,pub_traffic,pub_parking,pub_safety,TrafficArray,pub_cruise,pub_crosswalk,pub_speedbump
    ...
    if key == 'p':
        ...
        speedbump.data = True
        pub_speedbump.publish(speedbump)
    elif key == 'r':
    ...
    speedbump.data = False

if __name__ == "__main__":
    global Machine_State, TrafficArray,pub_avoidance,pub_stop,pub_traffic,pub_parking,pub_safety,pub_cruise,pub_crosswalk,pub_speedbump
    ...
    pub_speedbump = rospy.Publisher('/detect/speedbump_sign',Bool,queue_size=1)
